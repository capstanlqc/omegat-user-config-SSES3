/* :name = Update Customisation Bundle (SSES3) :description =
...
def customUrl = "https://cat.capstan.be/OmegaT/SSES3/index.php" //insert URL between quotes or set to "" (empty) to ask the user on the 1st run, don't comment out
